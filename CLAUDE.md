...
- **El barrido en `M` propiamente dicho**, que es la corrida 20 con `M = 1, 2, 3`. Se opera cambiando cinco líneas (los cuatro notebooks y el `.m`) y volviendo a correr; no hace falta código nuevo.
