% psbp_fd_iteracion.m - Escenario E (multimodalidad con tendencia por régimen (lineal)), corrida 23
%
% Paso 2 del ciclo Python -> MATLAB -> Python. Lee el contrato que escribio
% 23_01_simulaciones.ipynb, arma una lista plana de jobs y la reparte con
...
% distinto -escenario_E_r01_m01, _m02, _m03- con sus propios datos, contrato y
...
ESCENARIO_ID = "E";          % escenario de diagnostico (no es Algoritmo del anexo)
...
for M_FPCA = M_FPCA_LIST
    ...
    % Debe coincidir EXACTAMENTE con el de 23_01_simulaciones.ipynb. M viaja en
...
assert(n_jobs > 0, ...
    ['Ningun punto del barrido tiene artefactos de 23_01. Corre ' ...
     '23_01_simulaciones.ipynb para cada M de M_FPCA_LIST.']);
