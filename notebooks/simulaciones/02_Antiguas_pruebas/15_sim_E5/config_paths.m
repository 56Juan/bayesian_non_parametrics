...
function paths = config_paths(varargin)
    ...
    raw_dir        = fullfile(project_root, "data", "simulaciones", "raw", experiment_id);
    functional_dir = fullfile(project_root, "data", "simulaciones", "processed", "functional", experiment_id);
    predict_dir    = fullfile(project_root, "data", "simulaciones", "processed", "predict", experiment_id);
    report_dir     = fullfile(project_root, "reports", "simulaciones", experiment_id);
    artefact_dir   = fullfile(project_root, "artefact", "simulaciones", experiment_id);
