% psbp_fd_iteracion.m — Escenario 1 (Algoritmo 1 del anexo), corrida 11
%
% Paso 2 del ciclo Python -> MATLAB -> Python. Lee el contrato que escribio
% 20_01_simulaciones.ipynb, arma una lista plana de jobs (cadena x componente
...
% Debe coincidir EXACTAMENTE con el de 20_01_simulaciones.ipynb. M viaja en el
% ID porque cada valor del barrido escribe sus propios artefactos y trazas.
EXPERIMENT_ID = sprintf("%s_%d_r%02d_m%02d", BASENAME, ESCENARIO_ID, REPLICA_ID, M_FPCA);
...
assert(isfield(hp_json, "seed_base"), ...
    "hyperparameters.json no contiene 'seed_base'; regenera con 20_01.");
