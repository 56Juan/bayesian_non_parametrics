...
% psbp_fd_iteracion.m — Escenario LD (histeresis + duracion), corrida 46
%
...
% distinto -escenario_LD_1_r01_m01, _m02- con sus propios datos, contrato y
...
%
% Ejes del estudio:
%   ESCENARIO_ID : punto de la familia LD (1=histeresis + duracion Poisson
%                  desplazada, pendiente, n_lags=3).
...
ESCENARIO_ID = 1;            % dinamica IDENTICA a la del 45 (pendiente,
                             % n_lags=3) y los MISMOS priors; lo que cambia es
                             % el mecanismo de regimen. El 45 es el control.
