...
% 50_01_simulaciones.ipynb, arma una lista plana de jobs y la reparte con
...
for M_FPCA = M_FPCA_LIST
    ...
    assert(n_components == M_FPCA, ...
        ['[M=%d] %s declara M=%d pero su hyperparameters.json tiene %d ' ...
         'componentes. Regenera ese punto con 50_01.'], ...
...
n_jobs = numel(jobs);
assert(n_jobs > 0, ...
    ['Ningun punto del barrido tiene artefactos de 50_01. Corre ' ...
...
fprintf("\n   Continuar con 50_03_convergencia, con el mismo M_FPCA_LIST.\n");
