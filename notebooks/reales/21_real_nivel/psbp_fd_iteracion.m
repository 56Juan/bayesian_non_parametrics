...
% 21_01_datos.ipynb, arma una lista plana de jobs (cadena x componente FPCA) y
...
% Debe coincidir EXACTAMENTE con el de 21_01_datos.ipynb. M viaja en el ID
...
assert(isfield(hp_json, "seed_base"), ...
    "hyperparameters.json no contiene 'seed_base'; regenera con 21_01.");
