...
sim_escenario_B2.py
===================
Algoritmo B-2 del anexo (`ane_00_02_02_alg_b2`): proceso autorregresivo
funcional de coeficientes variables en el tiempo (TV-FAR).
...
from .sim_escenario_B1 import _ConfigBaseB, generar_far_funcional
