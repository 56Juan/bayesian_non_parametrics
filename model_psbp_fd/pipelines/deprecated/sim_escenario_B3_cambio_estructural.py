"""
sim_escenario_B3_cambio_estructural.py
========================================
HISTORICO. Generador original del Algoritmo B-3 (usado por la corrida 73, que
no se re-ejecuta). El anexo redefinio B-3 como una mezcla de mecanismos no
lineales con asignacion dependiente de la curva anterior (ver
`pipelines/sim_escenario_B3.py`, vigente); este modulo ya NO corresponde a lo
que `docs/01 Anexo.tex` llama B-3. Se conserva solo para que 73_01 siga siendo
legible como documento historico.

Contenido original: proceso con cambio estructural recurrente.
...
from .sim_escenario_B1_far import ConfigEscenarioB1, generar_far_funcional
